<?php
    ...
    Redux::setSection($opt_name, array(
        'title'            => __('Header and Footer', 'redux-framework-demo'),
        'id'               => 'header-fields',
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'default'  => 'Piroll Design, Inc.',
            ),
            array(
                'id'       => 'piroll-copyright',
                'type'     => 'text',
                'title'    => __( 'Copyright Text', 'redux-framework-demo' ),
                'default'  => '© 2017 Piroll. All rights reserved.',
            ),
            array(
                'id'       => 'piroll-email',
                'type'     => 'text',
                'title'    => __( 'Email', 'redux-framework-demo' ),
                'default'  => 'hello@pirolltheme.com',
            ),
            array(
                'id'       => 'piroll-number',
                'type'     => 'text',
